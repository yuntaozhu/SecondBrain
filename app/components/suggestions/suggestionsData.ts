...
export const stepOneSuggestions: StepOneSuggestion[] = [
    ...
    {
        type: SuggestionType.Medical,
        actionTagline: "Medical analysis",
        color: suggestionToColorMap[SuggestionType.Medical] || DEFAULT_COLOR,
        focus: ChatInputFocus.MESSAGE,
        intent: "Analysis Medical Concept",
    },
    {
...
export const stepTwoSuggestion: { [key: string]: StepTwoSuggestion[] } = {
    ...
    [SuggestionType.Learning]: [
        {
            prompt: "/research Develop a deep learning algorithm for the automated detection and quantification of subtle pathological changes in [specific medical imaging modality] with higher sensitivity and specificity than current methods.",
        },
        {
            prompt: "Can you explain the underlying mechanisms that lead to [symptom] in [disease]?.",
        },
        {
            prompt: "new drug target identification for [disease name].",
        },
        {
            prompt: "design of a phase III clinical trial for [drug] in [patient population]",
        },
        {
            prompt: "/research Investigate the allosteric modulation sites of [protein target] and propose novel small molecule modulators with enhanced selectivity and efficacy compared to orthosteric ligands..",
        },
    ],
    ...
    [SuggestionType.Medical]: [
        {
            prompt: "Find the concept in Medpub .",
        },
        {
            prompt: "Write a new drug target identification for [disease name].",
        },
        {
            prompt: "Explain pharmacophore modeling for [drug class].",
        },
        {
            prompt: "development of rapid diagnostic tests for infectious diseases .",
        },
        {
            prompt: "Write funding landscape for medical innovation.",
        },
    ],
