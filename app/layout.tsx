...
export const metadata: Metadata = {
    title: "YCK AI - Ask Anything",
    description:
        "YCK AI is a personal research assistant. It helps you understand better and create faster.",
    icons: {
    ...
    openGraph: {
        ...
        title: "YCK医创客 AI",
        description:
            "YCK is a personal research assistant. It helps you understand better and create faster.",
