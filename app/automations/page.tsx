...
const suggestedAutomationsMetadata: AutomationsData[] = [
    {
        subject: "Medical Weekly Newsletter 医疗新闻收集",
        scheduling_request:
            "/research Compile a message including: 1. A recap of news from last week 2. 微信的医疗新闻 3. A quote to inspire me for the week ahead",
    ...
    },
    {
        subject: "主要信息的总结",
        scheduling_request:
            "/research Summarize the top 5 posts from https://news. and share them with me, including links",
    ...
    },
    {
        ...
        scheduling_request:
            "Compose a work report of this day.  It should not exceed five paragraphs. Appeal to the imagination, but weave in learnings.",
